\section{Metoder}
    ...
    \end{figure} 
    Da syntesen sker med et overskud af alkohol vil der ideelt ske en fuldstændig reaktion. På baggrund heraf bestemmes det teoretiske udbytte ved at sætte stofmængden af 4--hydroxybenzoesyre lig stofmængden af parabenen der dannes under syntesen:
    \[
    ...
    \]
    Et regneark udarbejdes til bestemmelsen af det teoretiske udbytte gennem de resterende synteser, en version med værdierne for denne syntese kan ses under bilag.
    ...
    Efterfølgendende synteser udføres på samme måde, dog med alkoholen svarende til parabenen der ønskes at danne.
    ...
    Antibiotikaet der befinder sig i papirdisken vil \textit{diffundere}, dvs.\ vandre fra papirdisken og ud i agaren, hvilket medfører at der vil være en radius omkring disken hvor der ingen vækst er (hvis det antibakterielle middel er effektivt).
    \begin{figure}[H]\centering
        \begin{tikzpicture}
    ...
    Modsat agar--diffusion benyttes fortyndingsrækker til at bestemme definitive værdier (eller værdi--intervaller) for den minimale inhibitoriske koncentration af forskellige antibakterielle midler (antibiotika, konserveringsmidler, osv.). 
    ...
    En--dags inkuberet LB--medie, fremstilt af 10g trypton, 5g gærekstrakt og 5g NaCl fortyndet til $V=1\si{L}$ og herefter autoklaveret, og derefter poddet med bakterierne vi ønsker at undersøge fortyndes til $A_{600} \in \left[0.1;0.2\right]$, hvorefter $100\si{\mu L}$ overføres til hver brønd. En skematisk illustration af opstillingen kan ses nedenfor:
    \begin{figure}[H]\centering
        \resizebox{\linewidth}{!}{
        \begin{tikzpicture}
    ...
    Umiddelbart har vi forventninger til nogle afvigende målinger i brøndene med de højeste koncentrationer, da parabenen ikke kan holdes opløst og derfor vil ophobe sig på bunden af brøndene, hvilket vil gøre det nødvendigt at rydde op i de indsamlede data.
