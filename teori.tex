\section{Teori}
    ...
    \begin{table}[H]\centering
        ...
        \begin{tabular}{ccccc}
            \toprule
            & \multicolumn{2}{c}{Opløselighed $\left[\si{g\per 100g}\right]$} & & \\
            \cmidrule(r){2-3}
    ...
    \begin{figure}[H]
        ...
        \node at (5.4,2){$y$};
        \node at (3.4,4.5){$z$};
        \end{tikzpicture} \hskip -64pt 
        \begin{tikzpicture}
            \node at (0,0){};
            \draw[-stealth,solid] (0,2.25) -- node[above]{$\sum$} (1,2.25);
        ...
        \vskip -50pt \caption{Omdannelse fra magnetiske momenter til bulk magnetisering ved summation. Antal molekyler i højt-- og lavt energistadie repræsenterer ikke virkeligheden.}
    \end{figure}
    ...
    \end{figure}
    Bøjninger kan ske både i eget plan og vinkelret derpå. Dvs.\ at atomerne ikke udelukkende har mulighed for at bøje fra side til side, men også frem og tilbage. Derudover bevæger det centrale molekyle sig også, da molekylets massemidtpunkt \textit{ikke} kan forskydes af vibrationerne.
