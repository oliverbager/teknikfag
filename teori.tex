\section{Teori}
    ...
    Dette medfører at vores bulk magnetiseringsvektor ``tippes'' ud af ækvilibrium, ved at ændre atomernes spin og derved vende deres enkelte magnetiske momenter. Afhængigt af hvor længe prøven udsættes for dette ydre magnetfelt for, desto mere tipper magnetiseringsvektoren.
        ...
        \begin{tikzpicture}
            ...
            \draw[-stealth,ultra thick,cyan] (0,0) -- +(90:3) node[right,cyan]{$\vec{\mu}$};
            ...
            \draw[-stealth,ultra thick,cyan] (8,0) -- +(45:2) node[right,cyan]{$\vec{\mu}$};
            ...
            \draw[-stealth,ultra thick,cyan] (18,0) -- +(0:3) node[below,cyan]{$\vec{\mu}$};
