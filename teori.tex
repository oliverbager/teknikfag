\section{Teori}
    ...
    Som katalysator i denne proces benyttes koncentreret svovlsyre. Under esterificeringsreaktioner benyttes stærke organiske syrere for at muliggøre dannelsen af en carbokation, hvilket muliggør nukleofil addition. Dette gøres ved at den stærke syre overfører en proton til det carbonyle oxygenatom hvilket er muligt grundet elektronegativitetsforskellen. Dette medfører en stigning i det carbonyle carbonatoms elektrofilicitet ved dannelse af en carbokation.
    \begin{figure}[H]
        \resizebox{\linewidth}{!}{
            \schemestart
            ...
            \schemestop
            \chemmove{
                \draw[-stealth] ($(DB1)+(-0.075,0.075)$) to[bend left=65,looseness=2] ($(DB2)+(-0.175,0)$);
                \draw[-stealth] ($(DB2)+(0.2,0)$) to[bend left=65,looseness=1] ($(DB3)+(0,0.2)$);
            }
        }
        \caption{Dannelse af carbokation under reaktion med stærk syre.}
    \end{figure}
    Alkoholen har i denne reaktion mulighed for at agere som et nukleofil grundet de frie elektronpar på oxygenatomet. En nukleofil addition sker derfor ved carbokationen, hvorved alkoholet vedhæftes ved oxoniumionen dannet ved protonoverførsel fra carbokationen.
    \begin{figure}[H]
        \resizebox{\linewidth}{!}{
            \schemestart
            \chemfig[baseline=6pt]{@{DB1}C^{+}(-[::-30]OH)(-[::-150]R)(=[2]O)}
            \+
            \chemfig[baseline=-9pt]{R-[::-35]@{DB2}\charge{225=\:,315=\:}{O}-[::70]H}
            \arrow{->}
            \chemfig[]{C(-[6]O^{+}(-[::60]H)(-[::-60]R))(-[::-160]R)(-[2]O(-[::-60]H))-[::-30]O-[::60]H}
            \schemestop
            \chemmove{
                \draw[-stealth] ($(DB2)+(0,-0.3)$) to[bend left=85,looseness=1.25] ($(DB1)+(0,-0.2)$);
            }
        }
    ...
    \begin{figure}[H]
        \resizebox{\linewidth}{!}{
            \schemestart
            \chemfig{C(-[6]O(-[::-60]R))(-[::-160]R)(-[@{DB1}2]@{DB2}O^{+}(-[::-60]H)(-[::60]H))-[::-30]O-[::60]H}
            \arrow{->}
            \chemfig{O(-[::210]R)(-[2]C(-[::120]R)(-[::-120]O^{+}(-[::60]H)))}
            \+
            \chemfig{H_{2}O}
            \schemestop
            \chemmove{
                \draw[-stealth] ($(DB1)+(-0.1,0)$) to[bend left=90,looseness=3] ($(DB2)+(-0.35,0)$);
            }
        }
        \caption{Dannelse af aktivt kompleks ved protonoverførsel til hydroxygruppe.}
    \end{figure}
    Hvorved elektronenerne det kovalente bånd mellem oxoniumionen og hydrogenatomet opløses, hvilket frigiver elektronen deri og neutraliserer ladningsforskellen ved at frigive hydronen.
    \begin{figure}[H]
        \resizebox{\linewidth}{!}{
            \schemestart
            \chemfig{O(-[::210]R)(-[2]C(-[::120]R)(-[::-120]@{DB1}O^{+}(-[@{DB2}::60]H)))}
            \arrow{->}
            \chemfig{C(-[3]R)(-[5]OR)=O}
            \+
            \chemfig{H^{+}}
            \schemestop
            \chemmove{
                \draw[-stealth] ($(DB2)+(0,-0.1)$) to[bend left=75,looseness=3] (DB1);
            }
        }
        \caption{Udligning af ladning og gendannelse af dobbeltbinding ved frigivelse af hydron.}
